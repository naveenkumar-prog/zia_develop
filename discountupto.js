    ...
    fetch(getoffer+"operation=5", requestOptions)
            ...
            .then(result => {
                ...
                $('.deleteUsers').click(function () {
                    ...
                    deloff(offid, data,pre,product_id,offer_rank);
                });
...
function deloff(offid, data,pre,product_id,offer_rank) {
